...
export const FieldControl = ({
  ...
  return (
    <FieldPrimitive.Control
      className={createClassName(
        "h-10 w-full rounded-md border border-accent bg-transparent pl-3.5 text-base text-foreground focus:outline focus:outline-primary focus:-outline-offset-1",
        className,
      )}
      {...props}
    />
